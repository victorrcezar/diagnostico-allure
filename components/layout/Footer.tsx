      ...
      <Container>
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-8 md:gap-12">
          ...
          <div className="text-center md:text-left space-y-6">
            <img 
              src="https://static.wixstatic.com/media/1f17f3_c74aacad78ab41cbbf68badd4a6186cc~mv2.png/v1/fit/w_300,h_96,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/file.webp" 
              alt="Allure Logo" 
        ...
        <div className="mt-12 md:mt-16 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6 md:gap-4 text-xs text-slate-600 text-center md:text-left">
          ...
          <div className="flex items-center gap-2 opacity-60 hover:opacity-100 transition-opacity">
            ...
            >
              <img 
                src="https://static.wixstatic.com/media/1f17f3_d04973c55bd945bb9eaf8e5daf5c5197~mv2.png/v1/fit/w_160,h_48,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/file.webp" 
                alt="UP! Company Logo" 
